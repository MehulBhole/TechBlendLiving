                        ...
                        <div className="row">
                            ...
                            <div className="section-white mt-5 text-center">
                                ...
                                <div className="team-item" style={{ margin: '3%', padding: '0' }}>
                                    ...
                                    <br /><hr /><br />
                                    <div className="row">{/* Prasad */}
                                        <div className="col-md-2">
                                            <img src={teamMemberImage3} className="team-img" style={{ width: '100%', height: '30vh', marginBottom: '10px', marginTop: "20%" }} alt="pic" />
                                        </div>
                                        <div className="col-md-10">
                                            ...
                                            <div >
                                                ...
                                                <span className="icon-space"></span>
                                                <a href="https://www.linkedin.com/in/prasad-mali-3199441b3/" className="BsTwitter">
                                                    <BsTwitter className="twitter-icon" />
                                                    Twitter
                                                </a>
                                                {/* </div> */}
                                    ...
                                    <br /><hr /><br />
                                    <div className="row">{/* Shoeb */}
                                        <div className="col-md-2">
                                            <img src={teamMemberImage5} className="team-img" style={{ width: '100%', height: '30vh', marginBottom: '10px', marginTop: "20%" }} alt="pic" />
                                        </div>
                                        <div className="col-md-10">
                                            ...
                                            <div >
                                                ...
                                                <span className="icon-space"></span>
                                                <a href="https://www.linkedin.com/in/shoeb-afsar-20166b223/" className="BsTwitter">
                                                    <BsTwitter className="twitter-icon" />
                                                    Twitter
                                                </a>
                                                {/* </div> */}
                                    ...
                                    <br /><hr /><br />
                                    <div className="row">{/* Shwet */}
                                        <div className="col-md-2">
                                            <img src={teamMemberImage4} className="team-img" style={{ width: '100%', height: '30vh', marginBottom: '10px', marginTop: "20%" }} alt="pic" />
                                        </div>
                                        <div className="col-md-10">

                                            <div >
                                                <br />
                                                <h3 >Shwetal Talavdekar</h3>
                                                <br />
                                                <p >
                                                    ...
                                                    Enail- shwetalt856@gmail.com</p>
                                                {/* <div className="social-icons" style={{ display: 'flex', alignItems: 'center' }}> */}
                                                <a href="https://www.linkedin.com/in/shwetal-talavdekar-a1354b139/" className="BsLinkedin">
                                                    <BsLinkedin className="linkedin-icon" />
                                                    LinkedIn
                                                </a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span className="icon-space"></span>
